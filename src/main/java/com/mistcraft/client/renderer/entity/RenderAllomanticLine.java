package com.mistcraft.client.renderer.entity;
...
public class RenderAllomanticLine extends Render<EntityAllomanticLine> {
    public RenderAllomanticLine(RenderManager renderManagerIn) { super(renderManagerIn);}

    protected ResourceLocation getEntityTexture(EntityAllomanticLine entity) { return null; }

    public void doRender(EntityAllomanticLine entity, double x, double y, double z, float entityYaw, float partialTicks) {
        EntityPlayer entityplayer = entity.getAllomancer();
